...
class CommandGroup:
    ...
    参数:
        ...
        permission(1.9.0+): 对应 `permission` 属性
        only_to_me: 对应 `only_to_me` 属性
        privileged: 对应 `privileged` 属性
        shell_like: 对应 `shell_like` 属性
        expire_timeout(1.8.2+): 对应 `expire_timeout` 属性
        run_timeout(1.8.2+): 对应 `expire_timeout` 属性
        session_class(1.8.1+): 对应 `session_class` 属性
    """
    basename: Tuple[str]
    """命令名前缀。"""
    ...
    def command(self, name: Union[str, CommandName_T], *,
        ...
        参数:
            ...
            privileged: 同上
            shell_like: 同上
            expire_timeout(1.8.2+): 同上
            run_timeout(1.8.2+): 同上
            session_class(1.8.1+): 同上
